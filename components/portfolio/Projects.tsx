...
const allProjects = [
    {
        ...
        description:
            "Titan Green is a website I built to showcase the innovative Hydrogen Boat design by California State University, Fullerton's engineering students. After gathering information and choosing a design with the students, I built an engaging online platform spotlighting the fusion of advanced technology and eco-friendly marine engineering.",
